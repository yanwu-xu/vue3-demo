...
<template>
  <Page :pagination="pagination" :table-auto-height="false" show-search-value stretch @query="handleQuery">
    <template #search>
      <el-form :inline="true" :model="searchForm">
        <el-form-item label="输入框">
          <el-input v-model="searchForm.queryFiled1" placeholder="请输入"></el-input>
        </el-form-item>
        ...
        <el-form-item label="时间">
          <el-date-picker v-model="searchForm.queryFiled3" type="datetimerange" range-separator="至"
            start-placeholder="开始日期" end-placeholder="结束日期">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="级联">
          <el-cascader v-model="searchForm.queryFiled4" :options="options"></el-cascader>
        </el-form-item>
        <el-form-item>
